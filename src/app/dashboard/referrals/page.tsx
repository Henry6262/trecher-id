        ...
        <>
          ...
          <GlassCard className="p-5" cut={12}>
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 min-w-0 px-3 py-2.5 rounded font-mono text-sm text-[var(--trench-text)] truncate"
                ...
                <div className="space-y-2">
                  {stats.recentReferrals.map((ref) => (
                    <div key={ref.username} className="flex items-center gap-3 py-2 border-b border-[var(--trench-border)] last:border-0">
                      {ref.avatarUrl ? (
                        <img src={ref.avatarUrl} alt="" className="w-7 h-7 rounded-full object-cover" />
                      ) : (
                        <div className="w-7 h-7 rounded-full bg-[var(--trench-accent)] flex items-center justify-center text-[10px] font-bold text-black">
