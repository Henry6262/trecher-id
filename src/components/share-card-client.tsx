...
export function ShareCardClient({ user, stats, degenScore, pinnedTrades, shareUrl }: ShareCardClientProps) {
  ...
  return (
    ...
    >
      ...
      <CutCorner cut="lg" bg="rgba(8,12,18,0.88)" borderColor="rgba(0,212,255,0.15)" style={{ width: '100%', maxWidth: '560px' }}>
        <div className="flex flex-col items-center gap-5 px-8 py-8">
          ...
          <div className="flex gap-3 w-full">
            ...
            <CutButton variant="secondary" size="md" onClick={handleCopy} className="flex-1 justify-center">
